...
const String kaNurseGate = "$basePath$projectPath/nursegate_logo.png";
const String kaAffairs = "$basePath$projectPath/affairs_logo.png";
const String kaLocations = "$basePath$projectPath/locations_logo.png";
...
const String kaGoogleCerti = "$basePath$certificatePath/google.jpg";
const String kaHackerRankCerti = "$basePath$certificatePath/hackerrank.jpg";
const String kaInfosys_dsaCerti = "$basePath$certificatePath/infosys_dsa.jpg";
const String kaInfosys_javacerti = "$basePath$certificatePath/infosys_java.jpg";
